...
public class GUIRegPlatoD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboTipoPlato.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Plato del Dia", "Plato Especial"}));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (txtNombre.getText()!=null && txtDescripcion.getText()!=null && txtCodigo.getText()!=null && txtValor.getText()!=null 
            ...
            try{
                ...
                Messages.errorMessage("El plato ya esta registrado; Message: "+ex.getMessage(), " Error al registrar el plato");
            }
        }else{
            Messages.warningMessage("Falta llenar un campo por favor", " Advertencia ");
        }// TODO add your handling code here:
    ...
    private void cboTipoPlatoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cboTipoPlatoActionPerformed
        if (cboTipoPlato.getSelectedIndex()==1)
        {
