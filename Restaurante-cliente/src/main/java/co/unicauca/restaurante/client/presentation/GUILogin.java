...
import co.unicauca.restaurante.client.infra.Messages;
...
public class GUILogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione...", "Administrador"}));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(jComboBoxTipo.getSelectedIndex()>0){
            ...
            if (opcion.equals("Administrador") && password.equals("admin")) {
                ...
                Messages.errorMessage("Digite la contraseña correctamente por favor", "PASSWORD INVALID");
            }
        }else{
            Messages.errorMessage("Seleccione un usuario por favor", "USER INVALID");
        }
