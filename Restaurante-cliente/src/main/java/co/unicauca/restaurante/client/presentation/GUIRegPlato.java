...
public class GUIRegPlato extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboTipoPlato.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {"Plato Especial","Plato del Dia"}));
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        if (txtNombre.getText() != null && txtDescripcion.getText() != null && txtCodigo.getText() != null && txtValor.getText() != null) {
            ...
            try {
                ...
                JOptionPane.showMessageDialog(null, "El plato especial ya esta registrado" + ex.getMessage());
